...
public class SubCommentsLvl4Adapter extends  RecyclerView.Adapter<SubCommentsLvl4Adapter.SubCommentLvl4ViewHolder> {
    ...
    public SubCommentsLvl4Adapter(List<DataResponse> commentsLvl4,List<DataResponse> commentsLvl5,List<DataResponse> commentsLvl6,List<DataResponse> commentsLvl7,List<DataResponse> commentsLvl8, TextView parentTextView) {
    ...
    public void onBindViewHolder(@NonNull SubCommentsLvl4Adapter.SubCommentLvl4ViewHolder holder, int position) {
        ...
        if (mSubCommentsLvl5 != null) {
            ...
            SubCommentsLvl5Adapter subCommentsLvl5Adapter = new SubCommentsLvl5Adapter(mSubCommentsLvl4,mSubCommentsLvl5,mSubCommentsLvl6,mSubCommentsLvl7,mSubCommentsLvl8, holder.scTextView);
