...
public class SubCommentsLvl2Adapter extends RecyclerView.Adapter<SubCommentsLvl2Adapter.SubCommentLvl2ViewHolder>  {
    ...
    public SubCommentsLvl2Adapter(List<DataResponse> comments,List<DataResponse> commentsLvl3,List<DataResponse> commentsLvl4,List<DataResponse> commentsLvl5, TextView parentTextView) {
...
//            Log.d(TAG, "LVL2 " + currentComment.getText());
            ...
            SubCommentsLvl3Adapter subCommentsLvl3Adapter = new SubCommentsLvl3Adapter(mSubCommentsLvl3,mSubCommentsLvl4,mSubCommentsLvl5, holder.scTextView);
